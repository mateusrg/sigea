...
export default function Professores() {
  ...
  const professores = [
    { id: 1, name: 'Adão Smith', turmas: 3 },
    { id: 2, name: 'João Silva', turmas: 7 },
    { id: 3, name: 'Maria Oliveira', turmas: 5 },
  ];
            ...
            <ScrollView style={styles.scrollArea} contentContainerStyle={{ paddingBottom: 24 }}>
              ...
              <View style={styles.tableWrapper}>
                ...
                <View style={[styles.tableRow, styles.tableHeader]}>
                  ...
                  <Text style={[styles.tableHeaderCell, { flex: 2, textAlign: 'center' }]}>Número de Turmas</Text>
                  <Text style={[styles.tableHeaderCell, { flex: 0.8, textAlign: 'center' }]}>Ações</Text>
                </View>

                {/* Linhas da tabela */}
                {professores.map((professor) => (
                  <View key={professor.id} style={[styles.tableRow, styles.tableRowBorder]}>
                    <Text style={[styles.tableCell, { flex: 1 }]}>{professor.name}</Text>
                    <Text style={[styles.tableCell, { flex: 2, textAlign: 'center' }]}>{professor.turmas}</Text>

                    <View style={{ flex: 0.8, flexDirection: 'row', justifyContent: 'center', gap: 8 }}>
                      <TouchableOpacity
                        style={[styles.actionButton, { backgroundColor: '#3B82F6' }]}
                        onPress={() => console.log('Editar', professor.id)}
                      >
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() => console.log('Excluir', professor.id)}
                      >
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() => console.log('Designar', professor.id)}
                      >
              ...
              <TouchableOpacity
                ...
                onPress={() => console.log('Cadastrar Professor')}
              >
                <Text style={styles.criarButtonText}>Cadastrar Professor</Text>
              </TouchableOpacity>
            </ScrollView>
          </View>
          {/* Logout Modal */}
