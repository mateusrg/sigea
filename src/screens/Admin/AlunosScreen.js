...
export default function Alunos() {
  ...
  const alunos = [
    { id: 1, name: 'Emilia Durkheim', turma: 101 },
    { id: 2, name: 'Marcos Weber', turma: 202 },
    { id: 3, name: 'Felipe Bourdieu', turma: 303 },
  ];
            ...
            <ScrollView style={styles.scrollArea} contentContainerStyle={{ paddingBottom: 24 }}>
              ...
              <View style={styles.tableWrapper}>
                ...
                <View style={[styles.tableRow, styles.tableHeader]}>
                  <Text style={[styles.tableHeaderCell, { flex: 1 }]}>Alunos</Text>
                  <Text style={[styles.tableHeaderCell, { flex: 2, textAlign: 'center' }]}>Turma</Text>
                  <Text style={[styles.tableHeaderCell, { flex: 0.8, textAlign: 'center' }]}>Ações</Text>
                </View>

                {/* Linhas da tabela */}
                {alunos.map((aluno) => (
                  <View key={aluno.id} style={[styles.tableRow, styles.tableRowBorder]}>
                    <Text style={[styles.tableCell, { flex: 1 }]}>{aluno.name}</Text>
                    <Text style={[styles.tableCell, { flex: 2, textAlign: 'center' }]}>{aluno.turma}</Text>

                    <View style={{ flex: 0.8, flexDirection: 'row', justifyContent: 'center', gap: 8 }}>
                      <TouchableOpacity
                        style={[styles.actionButton, { backgroundColor: '#3B82F6' }]}
                        onPress={() => console.log('Editar', aluno.id)}
                      >
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() => console.log('Excluir', aluno.id)}
                      >
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() => console.log('Matricular', aluno.id)}
                      >
              ...
              <TouchableOpacity
                ...
                onPress={() => console.log('Cadastrar Aluno')}
              >
                <Text style={styles.criarButtonText}>Cadastrar Aluno</Text>
              </TouchableOpacity>
            </ScrollView>
          </View>
          {/* Logout Modal */}
